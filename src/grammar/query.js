...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$literalExpectation("PROJECT", false);
  var peg$e1 = peg$literalExpectation("FILTER", false);
  ...
  var peg$f0 = function(columns, condition) {
	return {columns: columns, condition: condition};
};
  var peg$f1 = function(names) {
	return names;
};
  var peg$f2 = function(column, operator, literal) {
  ...
  var peg$f5 = function(value) { return value.join(""); };
  var peg$f6 = function() { return BigInt(text()) };
